...
export enum ProtocolErrors {
  ...
  NO_STABLE_RATE_DEBT = '42', // 'User does not have stable rate debt in progress on this reserve'
  NO_VARIABLE_RATE_DEBT = '43', // 'User does not have variable rate debt in progress on this reserve'
